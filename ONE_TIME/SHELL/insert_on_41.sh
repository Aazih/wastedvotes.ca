...
mysql $DB -u root -p$PASS < ../SQL/on_41_parliament.sql
echo "Running perl to create district_contest"
../PERL/insert_district_contest.pl $DB_PERL on_41_district_contest.csv
echo "Running perl to create party leader"
../PERL/insert_party_leader.pl $DB_PERL on_41_party_leader.txt
